    ...
    <div className="rounded-xl shadow-lg border border-gray-700/50 overflow-hidden relative group transition-all duration-300 hover:shadow-2xl hover:scale-[1.02] bg-gradient-to-b from-gray-800/50 to-gray-900/50 backdrop-blur-sm">
      <Link href={`/watch-movie-deatils?id=${video._id}`}>
        <div className="relative overflow-hidden aspect-[2/3] bg-gray-900">
          ...
          {/* Video Type Badge */}
          <span
            className={`absolute top-2 left-2 text-white text-xs px-2 py-1 rounded-full font-medium ${
        ...
        <div className="p-4">
          ...
          {video.channelId && (
            <div className="flex items-center gap-2 mb-2">
              <img
                src={
                  video.channelId.logoUrl || "/assets/img/default-channel.png"
                }
...
const MovieList = () => {
  ...
  return (
    <section className="min-h-screen">
          ...
          <div className="flex-1 min-w-0">
                ...
                <p className="text-xs text-gray-400 mt-1">
                  ...
                  {userCountry && (
                    <span className="ml-2 inline-flex items-center gap-1">
                      ...
                      <span>
                        {userCountry.flag} Prices in {userCountry.currency}
                      </span>
                    </span>
                  )}
                </p>
            ...
            <div className="flex gap-2 mb-6 overflow-x-auto pb-2">
              ...
              <button
                onClick={() =>
                  handleFilterChange({
                    isFree: filters.isFree === "true" ? "" : "true",
                  })
                }
                className={`px-4 py-2 rounded-full text-sm font-medium whitespace-nowrap transition-all ${
                  filters.isFree === "true"
            ...
            {!isLoading && meta.totalPages > 1 && (
              <div className="flex justify-center items-center gap-2 mt-8">
                <button
                  ...
                  className="px-4 py-2 cursor-pointer text-sm border border-gray-600 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-white/5 transition-colors text-white"
                >
                  ← Prev
                </button>
                  ...
                  {[...Array(Math.min(meta.totalPages, 5))].map((_, i) => {
                    ...
                    return (
                      <button
                        ...
                        className={`w-10 cursor-pointer h-10 text-sm rounded-lg transition-all font-medium ${
                          currentPage === pageNum
                            ? "bg-gradient-to-r from-pink-600 to-red-600 text-white shadow-lg"
                ...
                <button
                  ...
                  className="px-4 cursor-pointer py-2 text-sm border border-gray-600 rounded-lg disabled:opacity-50 disabled:cursor-not-allowed hover:bg-white/5 transition-colors text-white"
                >
                  Next →
                </button>
              </div>
      ...
      <button
        className="fixed cursor-pointer bottom-25 right-6 bg-gradient-to-r from-red-500 to-pink-600 text-white p-4 rounded-full shadow-xl lg:hidden z-30 flex items-center gap-2 hover:from-red-600 hover:to-pink-700 transition-all"
