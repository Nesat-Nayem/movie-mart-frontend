  ...
  return (
    <div className="w-full lg:w-72 border border-gray-700 p-4 rounded-xl shadow-lg bg-[#13162f] sticky top-4">
          ...
          <div className="flex flex-wrap gap-1.5">
            ...
            {filters.videoType && (
              <span className="inline-flex items-center gap-1 px-2 py-1 bg-green-500/20 text-green-400 text-xs rounded-full border border-green-500/30">
                ...
                <button
                  onClick={() => handleFilterChange("videoType", "")}
                  className="hover:text-white"
                >
                  <FaTimes className="w-2.5 h-2.5" />
                </button>
      ...
      {onApply && (
        <button
          onClick={onApply}
          className="w-full cursor-pointer mt-4 py-2.5 text-sm font-medium bg-gradient-to-r from-pink-500 to-red-600 hover:from-pink-600 hover:to-red-700 text-white rounded-lg transition-all shadow-lg"
        >
