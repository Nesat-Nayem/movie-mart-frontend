  ...
  const handlePaymentVerification = async (paymentData) => {
    try {
      const verifyResult = await fetch(
        `${process.env.NEXT_PUBLIC_API_URL}/watch-videos/payment/verify`,
        {
          method: "POST",
          headers: {
  ...
  if (isError || !video) {
    return (
      <section className="min-h-screen flex flex-col items-center justify-center text-white">
        ...
        <Link
          href="/watch-movies"
          className="px-6 py-2 bg-pink-600 rounded-lg hover:bg-pink-700"
        >
          Browse Videos
        </Link>
      </section>
      ...
      <section>
        <div className="max-w-6xl mx-auto">
          <div className="min-h-screen text-white">
                ...
                <div className="relative aspect-video rounded-xl overflow-hidden">
                  ...
                  <div className="absolute inset-0 bg-black/70 flex flex-col items-center justify-center">
                    ...
                    <p className="text-gray-300 mb-4 text-center px-4">
                      Purchase this video for {video.userCurrency}{" "}
                      {video.userPrice} to start watching
                    </p>
                    <button
              ...
              <div className="flex flex-wrap items-center gap-3 mt-6">
                ...
                {/* {canWatch && video.downloadUrl && (
                  <a
                    ...
                    download
                    className="flex items-center gap-2 px-4 py-2 rounded-full bg-gradient-to-r from-green-600 to-emerald-600 hover:from-green-700 hover:to-emerald-700 text-white transition"
                  >
                ...
                <ShareModal
                  ...
                  title={video.title}
                  description={
                    video.description || `Watch ${video.title} on Movie Mart`
                  }
              ...
              {channel && (
                <div className="flex items-center justify-between mt-6 p-4 bg-white/5 rounded-xl">
                  ...
                  <button
                    ...
                    className={`flex cursor-pointer items-center gap-2 px-5 py-2 rounded-full font-medium transition ${
                      isSubscribed
            ...
            <div className="px-4 mt-8">
              ...
              {showReviewForm && (
                ...
                >
                  ...
                  <button
                    type="submit"
                    className="mt-3 cursor-pointer px-6 py-2 bg-pink-600 rounded-lg hover:bg-pink-700 transition"
                  >
                    Submit Review
                  </button>
                </form>
            ...
            <RelatedForYou currentVideoId={videoId} currentVideo={video} />
          </div>
        </div>
      </section>
    </>
